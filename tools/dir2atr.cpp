/*
   ...
   Copyright (C) 2004-2022 Matthias Reichl <hias@horus.com>
...
usage:
	printf("dir2atr %s\n", VERSION_STRING);
	printf("(c) 2004-%d Matthias Reichl <hias@horus.com>\n", CURRENT_YEAR);
	...
	printf("            Supported DOS are: Dos20, Dos25, OSAplus210, DosXL230\n");
